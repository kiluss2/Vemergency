...
import com.kiluss.vemergency.databinding.ActivityAdminEditProfileBinding
        ...
        with(binding) {
            ...
            user.id?.let {
                db.collection(ADMIN_COLLECTION)
                    ...
                    .addOnSuccessListener {
                        hideProgressbar()
                        Utils.showShortToast(this@AdminEditProfileActivity, "Edit successful")
                    ...
                    .addOnFailureListener {
                        hideProgressbar()
                        Utils.showShortToast(this@AdminEditProfileActivity, "Fail to update profile")
            ...
            imageApi.uploadPhoto(Utils.createRequestBodyForImage(iBase64))
                .enqueue(object : Callback<JsonObject?> {
                    ...
                    override fun onFailure(call: Call<JsonObject?>, t: Throwable) {
                        ...
                        hideProgressbar()
                        Utils.showShortToast(this@AdminEditProfileActivity, "Fail to upload avatar")
                        t.printStackTrace()
                    }
                })
        } else {
